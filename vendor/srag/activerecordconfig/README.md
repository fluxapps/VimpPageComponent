...
```php
//...
use srag\ActiveRecordConfig\VimpPageComponent\ActiveRecordConfigGUI;
//...
...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\VimpPageComponent\ActiveRecordConfigFormGUI;
//...
...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\VimpPageComponent\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\VimpPageComponent\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\VimpPageComponent\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
